...
```bash
npm init -y
npm install --save-dev @creatonproto/oauth-client-browser
npm install --save-dev @creatonproto/api
...
`Agent` class from `@creatonproto/api`. Let's make a simple call to the API to
