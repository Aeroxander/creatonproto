...
const knownSchemas = new Map<string, RecordSchema>(
  [
    ...
    app.creaton.forum.board.main,
    app.creaton.forum.comment.main,
    app.creaton.forum.member.main,
    app.creaton.forum.roleGrant.main,
    app.creaton.forum.topic.main,
    app.creaton.forum.vote.main,
