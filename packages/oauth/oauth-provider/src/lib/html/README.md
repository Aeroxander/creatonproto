...
`@creatonproto/oauth-provider` package, it is included here. Future development
should aim to keep this library independent of the rest of the
`@creatonproto/oauth-provider` package, so that it can be extracted and published.
