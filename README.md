...
| Package                                                                       | Docs                                       | NPM                                                                                                             |
| ----------------------------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| `@creatonproto/api`: client library                                                | [README](./packages/api/README.md)         | [![NPM](https://img.shields.io/npm/v/@creatonproto/api)](https://www.npmjs.com/package/@creatonproto/api)                 |
| `@creatonproto/common-web`: shared code and helpers which can run in web browsers  | [README](./packages/common-web/README.md)  | [![NPM](https://img.shields.io/npm/v/@creatonproto/common-web)](https://www.npmjs.com/package/@creatonproto/common-web)   |
| `@creatonproto/common`: shared code and helpers which doesn't work in web browsers | [README](./packages/common/README.md)      | [![NPM](https://img.shields.io/npm/v/@creatonproto/common)](https://www.npmjs.com/package/@creatonproto/common)           |
| `@creatonproto/crypto`: cryptographic signing and key serialization                | [README](./packages/crypto/README.md)      | [![NPM](https://img.shields.io/npm/v/@creatonproto/crypto)](https://www.npmjs.com/package/@creatonproto/crypto)           |
| `@creatonproto/identity`: DID and handle resolution                                | [README](./packages/identity/README.md)    | [![NPM](https://img.shields.io/npm/v/@creatonproto/identity)](https://www.npmjs.com/package/@creatonproto/identity)       |
| `@creatonproto/lexicon`: schema definition language                                | [README](./packages/lexicon/README.md)     | [![NPM](https://img.shields.io/npm/v/@creatonproto/lexicon)](https://www.npmjs.com/package/@creatonproto/lexicon)         |
| `@creatonproto/repo`: data storage structure, including MST                        | [README](./packages/repo/README.md)        | [![NPM](https://img.shields.io/npm/v/@creatonproto/repo)](https://www.npmjs.com/package/@creatonproto/repo)               |
| `@creatonproto/syntax`: string parsers for identifiers                             | [README](./packages/syntax/README.md)      | [![NPM](https://img.shields.io/npm/v/@creatonproto/syntax)](https://www.npmjs.com/package/@creatonproto/syntax)           |
| `@creatonproto/xrpc`: client-side HTTP API helpers                                 | [README](./packages/xrpc/README.md)        | [![NPM](https://img.shields.io/npm/v/@creatonproto/xrpc)](https://www.npmjs.com/package/@creatonproto/xrpc)               |
| `@creatonproto/xrpc-server`: server-side HTTP API helpers                          | [README](./packages/xrpc-server/README.md) | [![NPM](https://img.shields.io/npm/v/@creatonproto/xrpc-server)](https://www.npmjs.com/package/@creatonproto/xrpc-server) |
